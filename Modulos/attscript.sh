...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/bielsilva713/CrashVPN/main/versao
...
echo -e "                              \033[1;31mBy FAST NETCBA\033[1;36m"

echo -e "   FAST NETCBA" | figlet
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@fastnetcba\n"
  ...
  echo -e "  \033[1;33mMAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@fastnetcba\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/bielsilva713/CrashVPN/main/crashvpn > /dev/null 2>&1
